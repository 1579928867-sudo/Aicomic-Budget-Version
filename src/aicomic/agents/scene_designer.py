...
9. **Three-view scene prompts**: For every scene, generate three multi-angle image prompts:
    ...
    10. **Composite multi-view scene prompt (场景多景别合并提示词)**: For every scene, generate ONE composite prompt that renders all three camera distances as a vertically-stacked triptych in a single 9:16 portrait image. This MUST follow the "contact sheet" format below EXACTLY:
        - `multi_view_prompt`: Portrait/vertical composition (9:16), THREE equal horizontal strips separated by thick solid white bars. **Structure (top to bottom, each ~30% of image height):**
          ① **TOP** — Wide/panoramic (全景广角): show the FULL room/space layout, all walls, entrance, windows, furniture positions. This is an establishing shot that shows spatial relationships.
          ② **MIDDLE** — Mid shot (中景): zoom into the primary activity zone (e.g. the bed area, desk, or central focal point). Show the key furniture and props at medium distance.
          ③ **BOTTOM** — Close-up (特写): extreme detail shot of ONE key surface or object — material textures, wood grain, fabric weave, metal reflections, tool marks.
        - **White separator bars** (MANDATORY): Between each strip is a solid pure-white horizontal bar spanning the FULL width of the image, exactly 6px thick. The bars MUST be perfectly straight, horizontal, and continuous — no gaps, no curves. This is non-negotiable — without these bars the three views blend together and the image is unusable.
        - **Text labels** (MANDATORY): In the TOP-LEFT corner of each strip, white sans-serif Chinese text on a small black semi-transparent label background:
          - Top strip: 「远景 · Wide」
          - Middle strip: 「中景 · Mid」
          - Bottom strip: 「特写 · Close-up」
        - The prompt MUST begin with: "9:16竖屏构图，三等分场景多景别contact sheet，从上到下三格——"
        - Same rules as individual views: "不能出现其他人，无人纯场景，no humans, empty, landscape only", 写实电影感风格, era style prefix for ancient settings, real environment backgrounds (NOT pure white background — only the separator bars are white).
        - Then append full scene description details for each strip.
  ...
  "scenes": [
    {
      ...
      "full_prompt": "不能出现其他人，无人纯场景，no humans,empty,landscape only，古代仙侠风格，【中国古代·仙侠】写实电影感风格，全景展示场景全貌，横向16:9电影级场景设定图，极高画质，纯净无人的空间。婚房｜长方形中式古典卧室，深约5米宽约4米，地面深色木质地板，墙面浅米色墙纸，雕花窗棂透入柔和晨光，松软雕花大床垂下红色幔帐，床头大红喜字贴窗，喜庆中带着昏沉，暖黄色调。",
      "wide_view_prompt": "不能出现其他人，无人纯场景，no humans,empty,landscape only，古代仙侠风格，【中国古代·仙侠】写实电影感风格，全景广角展示场景全貌，横向16:9电影级场景设定图。婚房｜长方形中式古典卧室全景，深约5米宽约4米，地面深色木质地板延伸至远端，墙面浅米色墙纸，雕花窗棂在左侧透入柔和晨光，松软雕花大床居中偏右，红色幔帐垂下，床头矮柜和铜镜妆台在画面右侧。",
      "mid_view_prompt": "不能出现其他人，无人纯场景，no humans,empty,landscape only，古代仙侠风格，【中国古代·仙侠】写实电影感风格，中景展示场景核心区域，横向16:9电影级场景设定图。婚房｜雕花大床中景，红色幔帐纹理清晰，床头大红喜字贴窗细节，松软床铺褶皱可见，暖黄色调晨光从左侧窗棂洒入床面。",
      "close_view_prompt": "不能出现其他人，无人纯场景，no humans,empty,landscape only，古代仙侠风格，【中国古代·仙侠】写实电影感风格，特写展示场景关键细节，横向16:9电影级场景设定图。婚房｜铜镜妆台特写，铜镜表面反射柔和暖光，镜边雕花纹样精细，妆台上散落红绸和梳妆小物，材质质感清晰。",
      "multi_view_prompt": "不能出现其他人，无人纯场景，no humans,empty,landscape only，古代仙侠风格，【中国古代·仙侠】写实电影感风格，9:16竖屏构图，三等分场景多景别contact sheet，从上到下三格——第一格(远景·Wide)：全景广角展示整个长方形中式古典卧室，深约5米宽约4米，深色木质地板延伸到远端，雕花窗棂在左侧透入柔和晨光，松软雕花大床居中偏右悬挂红色曼联，床头矮柜和铜镜妆台在画面右侧，暖黄色调。第二格(中景·Mid)：中景聚焦雕花大床核心区域，红色曼联纹理清晰垂落，床头大红喜字贴窗，床面褶皱自然，晨光从左窗斜照在床面上。第三格(特写·Close-up)：特写铜镜妆台表面，铜镜反射柔暖光线，镜边雕花纹路精细，台面散落红绸和几件梳妆小盒，木质台面纹理清晰可见。三格之间用纯白色粗横条(6px)完全分隔，每格左上角黑色半透明底+白色文字标签。"
    }
  ]
}
"""
