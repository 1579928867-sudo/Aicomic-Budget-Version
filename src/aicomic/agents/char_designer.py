...
5. **Full prompt**: Generate a complete Chinese image-generation prompt (full_prompt) for each variant. This prompt must follow the format:
   - For characters in Chinese ancient settings: Start with "古代仙侠风格，" then "【时代背景】角色名（代称），性别 年龄，身高cm，九头身比例，3D动漫电影感风格，正面，站立的全身图片，图片人物背景为纯白色。发色发型；头饰；妆造脸部特征气质；上身描述；下身描述；脚上描述；配饰；双手自然下垂，手里无任何物品。"
...
8. **Art style: 3D 动漫/游戏 CG 风格** — 参考国产 3D 动画风格（如完美世界、斗破苍穹、凡人修仙传、眷思量等）。人物面部特征：轮廓锋利清晰，下颌线明显，颧骨和眉骨结构感强；五官精致但非写实真人比例——眼睛略大，鼻梁高挺，嘴唇线条分明；皮肤带有 CG 渲染质感，非真实皮肤纹理；头发带有细腻的 3D 建模感，发丝清晰但不追求照片级写实。**严格禁止**：照片级写实、真人比例五官、真实皮肤质感、AI 写真风格。
9. **For animals/beasts**: Different format — species, age, body length/height, fur/skin color/texture, facial features, distinctive decorations. Format: "【时代背景】3D动漫电影感风格，正面，全貌图片，图片背景为纯白色。角色名（代称）｜物种｜年龄｜体长/身高｜皮毛描述｜面部特征｜装饰"
...
10. **Three-view prompts**: For every variant, generate three view-specific image prompts:
    ...
    All three-view prompts keep the same style prefix (古代仙侠风格 for ancient settings), same era background tag, same pure white background rule, and same 3D动漫电影感风格.
    ...
    11. **Composite three-view prompt (三视图合并提示词)**: For every variant, generate ONE composite prompt that renders front, side, and back views together in a single image:
        - `three_view_prompt`: Left-to-right horizontal layout — left = side view (侧面全身站立), center = front view (正面特写全身站立), right = back view (背面全身站立). Same horizontal baseline, evenly spaced. Same style prefix (古代仙侠风格 for ancient, omitted for modern), same era tag (e.g. 【中国古代·仙侠】), pure white background (纯白色背景), 3D动漫电影感风格.
      ...
      "variants": [
        {
          ...
          "full_prompt": "古代仙侠风格，【中国古代·仙侠】萧澈（云澈），男 16岁，身高175cm，九头身比例，3D动漫电影感风格，正面，站立的全身图片，图片人物背景为纯白色。黑色长发束髻，白玉发冠束发；剑眉星目，清秀俊朗面容，肤色白净，气质坚毅淡然；上身白色交领长袍，领口云纹刺绣，袖口收束；下身同色系长衫，腰间墨玉腰带；脚上黑色云纹布靴；配饰左手掌心绿色天毒珠印记；双手自然下垂，手里无任何物品。",
          "front_view_prompt": "古代仙侠风格，【中国古代·仙侠】萧澈（云澈），男 16岁，身高175cm，九头身比例，3D动漫电影感风格，正面特写全身站立图片，人物居中，图片人物背景为纯白色。黑色长发束髻，白玉发冠束发；剑眉星目，清秀俊朗面容，肤色白净，气质坚毅淡然；上身白色交领长袍，领口云纹刺绣，袖口收束；下身同色系长衫，腰间墨玉腰带；脚上黑色云纹布靴；配饰左手掌心绿色天毒珠印记；双手自然下垂。",
          "side_view_prompt": "古代仙侠风格，【中国古代·仙侠】萧澈（云澈），男 16岁，身高175cm，3D动漫电影感风格，侧面全身站立图片，展示身体侧轮廓和服装侧面细节，图片人物背景为纯白色。黑色长发束髻侧面，白玉发冠侧影；上身白色交领长袍侧面云纹刺绣；下身同色系长衫侧面，墨玉腰带；脚上黑色云纹布靴侧面；双手自然下垂。",
          "back_view_prompt": "古代仙侠风格，【中国古代·仙侠】萧澈（云澈），男 16岁，身高175cm，3D动漫电影感风格，背面全身站立图片，展示背面发型和服装背面设计，图片人物背景为纯白色。黑色长发束髻背面，白玉发冠背面；上身白色交领长袍背面云纹刺绣；下身同色系长衫背面，墨玉腰带；脚上黑色云纹布靴背面；双手自然下垂。",
          "three_view_prompt": "古代仙侠风格，【中国古代·仙侠】萧澈（云澈），男 16岁，3D动漫电影感风格，三视图角色设定图，纯白色背景。画面从左到右排列三个视角：左侧为侧面全身站立（展示身体侧轮廓与服装侧面细节），中间为正面全身站立（正面特写，人物居中），右侧为背面全身站立（展示背面发型与服装背面设计）。三视图间距均匀，同一水平线对齐。黑色长发束髻，白玉发冠；剑眉星目，清秀俊朗面容，肤色白净，气质坚毅淡然；上身白色交领长袍，领口云纹刺绣，袖口收束；下身同色系长衫，腰间墨玉腰带；脚上黑色云纹布靴；配饰左手掌心绿色天毒珠印记；双手自然下垂，手里无任何物品。"
        }
      ]
    }
  ]
